...
if(isset($_GET['search'])){
    ...
    $data = mysqli_query($meong, "SELECT *  FROM `wisata` WHERE `namaKategori` LIKE 'wisata pemandian'");
  }
  $no = 1;
    ...
    <div class="middle aligned content">
      ...
      <div class="extra">
        <div class="ui right floated button">
          <a href="viewCangar.php">See more</a>
        </div>
      </div>
    </div>
  </div>
...
<?php
  ...
  <div class="item">
    ...
    <div class="middle aligned content">
      ...
      <div class="extra">
        <div class="ui right floated button">
          <a href="viewSonggoriti.php">See more</a>
        </div>
      </div>
    </div>
  </div>
