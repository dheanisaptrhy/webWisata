...
if(isset($_GET['search'])){
    ...
    $data = mysqli_query($meong, "SELECT *  FROM `wisata` WHERE `namaKategori` LIKE 'wisata kuliner'");
  }
  $no = 1;
    ...
    <div class="middle aligned content">
      ...
      <div class="extra">
        <div class="ui right floated button">
          <a href="viewBakso.php">See more</a>
        </div>
      </div>
    </div>
  </div>
...
<?php
  ...
  <div class="item">
    ...
    <div class="middle aligned content">
      ...
      <div class="extra">
        <div class="ui right floated button">
          <a href="viewKober.php">See more</a>
        </div>
      </div>
    </div>
  </div>
